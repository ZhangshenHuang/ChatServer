...
unordered_map<string, string> commandMap = {
    {"addfriend", "e.g. 'addfriend:friendid'"},
    {"chat", "e.g. 'chat:friendid:message'"},
    {"creategroup", "e.g. 'creategroup:groupname:groupdesc'"},
    {"addgroup", "e.g. 'addgroup:groupid'"},
    {"groupchat", "e.g. 'groupchat:groupid:message'"},
    {"loginout", "e.g. 'loginout'"},
    {"help", "e.g. 'help'"}
};
...
void mainMenu(int clientfd) {
    ...
    while (isMainMenuRunning) {
        ...
        if (idx == -1) {
            command = commandbuf;   // 未找到":", help 或loginout指令
        } else {
